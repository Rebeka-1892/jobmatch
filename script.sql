...
CREATE SEQUENCE "public".annonce_idannonce_seq AS integer START WITH 1 INCREMENT BY 1;

CREATE SEQUENCE "public".candidat_idcandidat_seq AS integer START WITH 1 INCREMENT BY 1;

CREATE SEQUENCE "public".competence_candidat_id_seq AS integer START WITH 1 INCREMENT BY 1;

CREATE SEQUENCE "public".competence_idcompetence_seq AS integer START WITH 1 INCREMENT BY 1;

CREATE SEQUENCE "public".detail_annonce_iddetail_seq AS integer START WITH 1 INCREMENT BY 1;

CREATE SEQUENCE "public".entreprise_identreprise_seq AS integer START WITH 1 INCREMENT BY 1;

CREATE SEQUENCE "public".experience_idexperience_seq AS integer START WITH 1 INCREMENT BY 1;

CREATE SEQUENCE "public".ignore_idignore_seq AS integer START WITH 1 INCREMENT BY 1;

CREATE SEQUENCE "public".match_idmatch_seq AS integer START WITH 1 INCREMENT BY 1;

CREATE SEQUENCE "public".niveau_etude_annonce_id_seq AS integer START WITH 1 INCREMENT BY 1;

CREATE SEQUENCE "public".niveau_etude_idniveau_etude_seq AS integer START WITH 1 INCREMENT BY 1;

CREATE SEQUENCE "public".parcours_idparcours_seq AS integer START WITH 1 INCREMENT BY 1;

CREATE SEQUENCE "public".preference_idpreference_seq AS integer START WITH 1 INCREMENT BY 1;

CREATE SEQUENCE "public".type_emploi_idtype_emploi_seq AS integer START WITH 1 INCREMENT BY 1;

CREATE SEQUENCE "public".type_lieu_idtype_lieu_seq AS integer START WITH 1 INCREMENT BY 1;
